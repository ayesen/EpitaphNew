...
Shader "Toon"
{
	Properties
	{
		...
		[ASEEnd]_Color("Color", Color) = (0.6981132,0.25356,0.25356,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float4 transform41 = mul(GetObjectToWorldMatrix(),float4( ( _Thickness * v.ase_normal ) , 0.0 ));
				...
				#endif
				float3 vertexValue = transform41.xyz;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
...
/*ASEBEGIN
Version=18912
1019;602;510;397;51.95734;292.0689;1.745919;False;False
...
Node;AmplifyShaderEditor.NormalVertexDataNode;8;-201.4835,-74.52057;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;34;5;41;0
ASEEND*/
//CHKSM=A591BF9656485800D8B29FE4066C894E4E00CB94